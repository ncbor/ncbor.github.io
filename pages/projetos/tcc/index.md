...
**Utilitário:** Plataformas cujos algoritmos atuam como utilitários no dia a dia da população, geralmente para intermediar o acesso à informações essenciais, que antes eram exclusivamente disponíveis por dispositivos, ferramentas e objetos físicos. **Possíveis exemplos:** Google Maps, Google Search, Waze, LinkedIn, entre outros (adicionar referência para cada um deles).
